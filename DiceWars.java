...
public class DiceWars {
    ...
    void program() {
        ...
        while (inGame){
            ...
            while (true){
                ...
                do {
                   out.println("Choose 1 for attack or 2 to continue");
                    input = scan.nextInt();
               ...
               do {
                   out.println("From where do you want to attack?");
                   from = scan.nextInt();
                ...
                do {
                    ...
                    to = scan.nextInt();
                    if (to >= 0 && to <= 8 && owners[to] != attacker && hasBorder(from, to, map)){ // Det går att fasta i en loop här
                        break;
                    }
                }while (true);
            ...
            dices = putOutDices(dices, owners, attacker, random);
            plotMap(map, owners, dices, players);
    ...
    boolean hasBorder(int i, int j, int[] map){
        ...
        //out.println(dissected.length);
        //out.println(value);
        //out.println(Arrays.toString(dissected));
    ...
    int[] putOutDices(int[] dices, int[] owners, int player, Random random){
